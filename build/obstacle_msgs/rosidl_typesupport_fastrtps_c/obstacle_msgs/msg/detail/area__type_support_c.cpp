...
#include "obstacle_msgs/msg/detail/area__rosidl_typesupport_fastrtps_c.h"
...
using _Area__ros_msg_type = obstacle_msgs__msg__Area;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: obstacle_area_status
  {
    cdr << ros_message->obstacle_area_status;
  }
  ...
  // Field name: obstacle_lat_1
  {
    cdr << ros_message->obstacle_lat_1;
  }

  // Field name: obstacle_long_1
  {
    cdr << ros_message->obstacle_long_1;
  }

  // Field name: obstacle_lat_2
  {
    cdr << ros_message->obstacle_lat_2;
  }

  // Field name: obstacle_long_2
  {
    cdr << ros_message->obstacle_long_2;
  }
...
size_t get_serialized_size_obstacle_msgs__msg__Area(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name obstacle_area_status
  {
    size_t item_size = sizeof(ros_message->obstacle_area_status);
  ...
  // field.name obstacle_direction
  {
    size_t item_size = sizeof(ros_message->obstacle_direction);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name obstacle_length
  ...
  // field.name obstacle_lat_1
  {
    size_t item_size = sizeof(ros_message->obstacle_lat_1);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name obstacle_long_1
  {
    size_t item_size = sizeof(ros_message->obstacle_long_1);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name obstacle_lat_2
  {
    size_t item_size = sizeof(ros_message->obstacle_lat_2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name obstacle_long_2
  {
    size_t item_size = sizeof(ros_message->obstacle_long_2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Area__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_obstacle_msgs__msg__Area(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_obstacle_msgs
size_t max_serialized_size_obstacle_msgs__msg__Area(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = obstacle_msgs__msg__Area;
    is_plain =
      (
      offsetof(DataType, obstacle_long_2) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Area__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_obstacle_msgs__msg__Area(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, obstacle_msgs, msg, Area)() {
