...
#include "obstacle_msgs/msg/detail/status__rosidl_typesupport_fastrtps_c.h"
...
using _Status__ros_msg_type = obstacle_msgs__msg__Status;
...
size_t get_serialized_size_obstacle_msgs__msg__Status(
  const void * untyped_ros_message,
...
static uint32_t _Status__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_obstacle_msgs__msg__Status(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_obstacle_msgs
size_t max_serialized_size_obstacle_msgs__msg__Status(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, obstacle_length) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Status__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_obstacle_msgs__msg__Status(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, obstacle_msgs, msg, Status)() {
