...
bool obstacle_msgs__msg__area__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // obstacle_lat_1
    PyObject * field = PyObject_GetAttrString(_pymsg, "obstacle_lat_1");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->obstacle_lat_1 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // obstacle_long_1
    PyObject * field = PyObject_GetAttrString(_pymsg, "obstacle_long_1");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->obstacle_long_1 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // obstacle_lat_2
    PyObject * field = PyObject_GetAttrString(_pymsg, "obstacle_lat_2");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->obstacle_lat_2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // obstacle_long_2
    PyObject * field = PyObject_GetAttrString(_pymsg, "obstacle_long_2");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->obstacle_long_2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * obstacle_msgs__msg__area__convert_to_py(void * raw_ros_message)
{
  ...
  {  // obstacle_lat_1
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->obstacle_lat_1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "obstacle_lat_1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // obstacle_long_1
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->obstacle_long_1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "obstacle_long_1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // obstacle_lat_2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->obstacle_lat_2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "obstacle_lat_2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // obstacle_long_2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->obstacle_long_2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "obstacle_long_2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
