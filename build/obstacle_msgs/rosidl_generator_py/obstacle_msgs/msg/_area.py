...
class Area(metaclass=Metaclass_Area):
    ...
    _fields_and_field_types = {
        ...
        'obstacle_lat_1': 'double',
        'obstacle_long_1': 'double',
        'obstacle_lat_2': 'double',
        'obstacle_long_2': 'double',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.obstacle_lat_1 = kwargs.get('obstacle_lat_1', float())
        self.obstacle_long_1 = kwargs.get('obstacle_long_1', float())
        self.obstacle_lat_2 = kwargs.get('obstacle_lat_2', float())
        self.obstacle_long_2 = kwargs.get('obstacle_long_2', float())
    ...
    def __eq__(self, other):
        ...
        if self.obstacle_length != other.obstacle_length:
            return False
        if self.obstacle_lat_1 != other.obstacle_lat_1:
            return False
        if self.obstacle_long_1 != other.obstacle_long_1:
            return False
        if self.obstacle_lat_2 != other.obstacle_lat_2:
            return False
        if self.obstacle_long_2 != other.obstacle_long_2:
            return False
        return True
    ...
    @builtins.property
    def obstacle_lat_1(self):
        """Message field 'obstacle_lat_1'."""
        return self._obstacle_lat_1

    @obstacle_lat_1.setter
    def obstacle_lat_1(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'obstacle_lat_1' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'obstacle_lat_1' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._obstacle_lat_1 = value

    @builtins.property
    def obstacle_long_1(self):
        """Message field 'obstacle_long_1'."""
        return self._obstacle_long_1

    @obstacle_long_1.setter
    def obstacle_long_1(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'obstacle_long_1' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'obstacle_long_1' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._obstacle_long_1 = value

    @builtins.property
    def obstacle_lat_2(self):
        """Message field 'obstacle_lat_2'."""
        return self._obstacle_lat_2

    @obstacle_lat_2.setter
    def obstacle_lat_2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'obstacle_lat_2' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'obstacle_lat_2' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._obstacle_lat_2 = value

    @builtins.property
    def obstacle_long_2(self):
        """Message field 'obstacle_long_2'."""
        return self._obstacle_long_2

    @obstacle_long_2.setter
    def obstacle_long_2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'obstacle_long_2' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'obstacle_long_2' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._obstacle_long_2 = value
