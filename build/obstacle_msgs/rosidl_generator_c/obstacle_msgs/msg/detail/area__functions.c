...
obstacle_msgs__msg__Area__are_equal(const obstacle_msgs__msg__Area * lhs, const obstacle_msgs__msg__Area * rhs)
{
  ...
  // obstacle_area_status
  if (lhs->obstacle_area_status != rhs->obstacle_area_status) {
    return false;
  }
  // obstacle_distance
  ...
  // obstacle_direction
  if (lhs->obstacle_direction != rhs->obstacle_direction) {
    return false;
  }
  // obstacle_length
  ...
  // obstacle_lat_1
  if (lhs->obstacle_lat_1 != rhs->obstacle_lat_1) {
    return false;
  }
  // obstacle_long_1
  if (lhs->obstacle_long_1 != rhs->obstacle_long_1) {
    return false;
  }
  // obstacle_lat_2
  if (lhs->obstacle_lat_2 != rhs->obstacle_lat_2) {
    return false;
  }
  // obstacle_long_2
  if (lhs->obstacle_long_2 != rhs->obstacle_long_2) {
    return false;
  }
  return true;
}
  ...
  obstacle_msgs__msg__Area * output)
{
  ...
  // obstacle_area_status
  output->obstacle_area_status = input->obstacle_area_status;
  // obstacle_distance
  output->obstacle_distance = input->obstacle_distance;
  // obstacle_direction
  output->obstacle_direction = input->obstacle_direction;
  // obstacle_length
  output->obstacle_length = input->obstacle_length;
  // obstacle_lat_1
  output->obstacle_lat_1 = input->obstacle_lat_1;
  // obstacle_long_1
  output->obstacle_long_1 = input->obstacle_long_1;
  // obstacle_lat_2
  output->obstacle_lat_2 = input->obstacle_lat_2;
  // obstacle_long_2
  output->obstacle_long_2 = input->obstacle_long_2;
  return true;
}
