...
#include "obstacle_msgs/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const obstacle_msgs::msg::Status & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  obstacle_msgs::msg::Status & ros_message)
{
  // Member: obstacle_area_status
  cdr >> ros_message.obstacle_area_status;
...
{
  auto typed_message =
    static_cast<const obstacle_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<obstacle_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  return &obstacle_msgs::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, obstacle_msgs, msg, Status)() {
  return &obstacle_msgs::msg::typesupport_fastrtps_cpp::_Status__handle;
}
